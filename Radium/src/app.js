			...
			<Frame>
				...
				<Carousel showIndex={this.state.showIndex} nav={this.renderNav()} width={configStyles.imageWidth}>
					<Slide image={require('./images/1.jpg')} title="Imperial Mockery">
						...
						Square when found this morning.
					</Slide>
					<Slide image={require('./images/2.jpg')} title="Trooper Initiation">
						In a tradition that predates the Empire, Troopers seen here are made to suffer the agony of the
						limbo line. Such initiation techniques are currently under Imperial review.
					</Slide>
					<Slide image={require('./images/3.jpg')} title="Master and Apprentice">
						...
						that line of work. They will likely be able to show you what it's really like before you commit
						your future.
					</Slide>
					<Slide image={require('./images/4.jpg')} title="Battle of Coruscant">
						...
						Coruscant. Various plans for future machines of war were used as filler.
					</Slide>
					<Slide image={require('./images/5.jpg')} title="The Wiles of the Forest">
						...
						possibility rotating troopers stationed on the forest moons of Endor after several rotations.
					</Slide>
				</Carousel>
			</Frame>
		);
